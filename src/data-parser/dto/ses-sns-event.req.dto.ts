...
} from '../../conf/utils/validation.dto';
import SesSnsEventFormatedDto from './ses-sns-event.formated.dto';

//property validation for DTO
...
export class SesSnsEventDto {
  ...
  static formatDto(eventDto: EventDto): SesSnsEventFormatedDto {
    const { ses } = eventDto;

    const formatedDto: SesSnsEventFormatedDto = {
    ...
    return plainToInstance(SesSnsEventFormatedDto, formatedDto);
  }
}
